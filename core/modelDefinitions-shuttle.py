...
class shuttle(master.LTI_master):
    ...
    def __init__(self):
        ...
        # self.setup['specification']['critical'] = np.vstack((
        #         setStateBlock(self.setup['partition'], a=[-.2, -.4, -.6, -.8, -1, .2, .4, .6, .8, 1], b=[-.05, -.15], c='all', d='all'),
        #         setStateBlock(self.setup['partition'], a=[-.4, -.6, -.8, -1, .4, .6, .8, 1], b=[-.25, -.35], c='all', d='all'),
        #         setStateBlock(self.setup['partition'], a=[-.6, -.8, -1, .6, .8, 1], b=[-.45, -.55], c='all', d='all'),
        #         setStateBlock(self.setup['partition'], a=[-.8, -1, .8, 1], b=[-.65, -.75], c='all', d='all'),
        #         setStateBlock(self.setup['partition'], a=[-1, 1], b=[-.85, -.95], c='all', d='all')
        #         ))
